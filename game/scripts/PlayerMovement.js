let playerPosX = 300; // start position of the player
...
let jumpSpeed = 2; // descr ibe, how fast the height of the player will reach "jumpHeight"
...
let jumpXValue = 10; // value for moving the player right while jumping
